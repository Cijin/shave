...
db-up:
	@GOOSE_MIGRATION_DIR=$(MIGRATION_DIR) GOOSE_DBSTRING=$(DB_URL) goose postgres up

db-down:
	@GOOSE_MIGRATION_DIR=$(MIGRATION_DIR) GOOSE_DBSTRING=$(DB_URL) goose postgres down

db-down-all:
	@GOOSE_MIGRATION_DIR=$(MIGRATION_DIR) GOOSE_DBSTRING=$(DB_URL) goose postgres down-to 0
